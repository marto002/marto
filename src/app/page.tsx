...
export default function Home() {
  ...
  <p className="text-[#000] text-[23px]  md:text-[50px] text-center">Our Specialities</p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4 py-12 w-full max-w-6xl">
    {services.map((service, index) => (
      ...
      >
        ...
        <h3 className="text-[18px] md:text-[22px] font-normal text-black mb-2">{service.title}</h3>
        <p className="text-gray-600 text-[14px] md:text-[15px]">{service.description}</p>
      </div>
    ))}
  </div>
</section>
...
<div className="flex flex-col-reverse lg:flex-row px-4 lg:px-15 md:py-[225px] py-0 pt-20 lg:pt-40 justify-center text-center relative z-10">
  ...
  <section className="bg-white justify-center text-center items-center px-25 md:py-[100px] py-10 md:px-0 flex flex-col gap-5">
    ...
    <div className="bg-[#33accc] justify-center items-center p-5 rounded-full flex md:w-[70px] w-[50px] md:h-[70px] h-[50px]"> <FaTrophy color="#fff" size={30}/></div>
   
   <h1 className="text-[#000] md:text-[50px] text-[19px] "> Always Delivering Best Of Our Services</h1>
...
<div className="flex flex-col-reverse lg:flex-row px-4 lg:px-15 md:py-[225px] py-0 pt-20 lg:pt-40 justify-center text-center relative z-10">
    ...
    <div className="bg-[#33accc] justify-center items-center p-5 rounded-full flex md:w-[70px] w-[50px] md:h-[70px] h-[50px]"> <BsEmojiSmile  color="#fff" size={30}/></div>
